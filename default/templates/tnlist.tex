...
<<% block table_body %>>
    <<% for registration in registrations %>>
        <<< registration.name.organizational_forename|e >>> & <<< registration.name.organizational_surname|e >>> &
        \href{mailto:<<< registration.name.mail|e >>> <<< '<' + registration.email|e + '>' >>>}{<<< registration.email|e >>>} &
